...
module.exports = async function({ message }) {
    let content = /*html*/`
        <div id=page>
            <div class=page-title><div><h1>Validate Ticket</h1></div></div>
            <div class=page-body class=narrow>
            ${ message ? `<div class="highlight error">${ message }</div>` : '' }
                <p>Please enter your Ticket Reference below.<p>
                <p><em>Tip: You can find this in an email that was sent to you with the subject "Your CascadiaJS 2020 Ticket".</em></p>

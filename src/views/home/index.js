        ...
        <div id=page>
            ...
            <div id="home" class="page-body narrow">
                ...
                <ul>
                    ...
                    <li><span class="cta"><a href="${ process.env.REMO_EVENING_URL }" target="_karaoke">Evening Social / Remo (Sept 2)</a></span></li>
                </ul>
                ` : '' }
                
                <h2>Need Help?</h2>
                <ul>
                    <li><span class="cta"><a href="/handbook" target="_handbook">Conference Handbook</a></span></li>
                    <li><span class="cta"><a href="/faq" target="_faq">FAQ</a></span></li>
                </ul>
                <h2>Reset Session</h2>
